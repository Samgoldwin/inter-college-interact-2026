...
export async function sendOtpEmail(
  ...
  await transporter.sendMail({
    from: `"INNOVATE IGNITE '26" <${process.env.SMTP_EMAIL}>`,
    to: email,
    subject: "Your OTP for INNOVATE IGNITE '26 Registration",
    html: `
      <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:32px;border:1px solid #e5e7eb;border-radius:8px;">
        <h2 style="color:#111827;margin-bottom:8px;">INNOVATE IGNITE '26</h2>
        ...
        <p style="color:#9ca3af;font-size:12px;margin-top:16px;">Vijaya Vittala Institute of Technology · INNOVATE IGNITE '26</p>
      </div>
    `,
  });
}
...
export async function sendPasswordResetEmail(
  ...
  await transporter.sendMail({
    from: `"INNOVATE IGNITE '26" <${process.env.SMTP_EMAIL}>`,
    to: email,
    subject: "Reset your INNOVATE IGNITE '26 password",
    html: `
      <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:32px;border:1px solid #e5e7eb;border-radius:8px;">
        <h2 style="color:#111827;margin-bottom:8px;">INNOVATE IGNITE '26</h2>
