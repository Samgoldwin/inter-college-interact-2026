        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          ...
          >
            ...
            <p className="text-[hsl(var(--muted-foreground))] text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              We extend our heartfelt gratitude to the incredible organizations driving INNOVATE IGNITE '26 forward. Their support makes this techno-cultural fest a reality.
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-2xl relative z-10">
          ...
          >
            ...
            <p className="text-[hsl(var(--muted-foreground))] mb-10 text-lg">
              ...
              Partner with INNOVATE IGNITE '26 and be a part of the biggest techno-cultural fest.
            </p>
            <Link
              href="/contactus"
