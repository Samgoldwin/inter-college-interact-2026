        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          ...
          >
            ...
            <p className="text-[hsl(var(--muted-foreground))] text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              A legacy of academic excellence, innovation, and transformative education in pursuit of knowledge.
            </p>
          </motion.div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <h2 className="font-display text-3xl font-bold text-[hsl(var(--foreground))] mb-4">
                Inspiring Futures Since 2008
              </h2>
              <p className="text-lg leading-relaxed text-[hsl(var(--muted-foreground))]">
                Vijaya Vittala Institute of Technology (VVIT), <strong className="text-[hsl(var(--foreground))]">established in 2008</strong>, is one of the most sought-after engineering and management colleges in Bengaluru, Karnataka. Nestled within a sprawling campus, VVIT provides an ideal environment for students to excel academically amidst an atmosphere of innovation and optimism.
              </p>
              <p className="text-lg leading-relaxed text-[hsl(var(--muted-foreground))]">
                This year <strong className="text-[hsl(var(--secondary))]">2026</strong> marks a momentous milestone as the institution continues to grow in pursuit of knowledge — advancing academic excellence, innovation, and transformative education. With a legacy of shaping future leaders and achievers, VVIT continues to set benchmarks in higher education, solidifying its position as a premier destination for aspiring engineers and managers.
              </p>
              <p className="text-lg leading-relaxed text-[hsl(var(--muted-foreground))]">
                VVIT offers ample opportunities for various co-curricular and extracurricular activities, ensuring a well-rounded student experience. The campus is home to dedicated students and experienced staff members committed to an effective teaching and learning process.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-base leading-relaxed text-[hsl(var(--muted-foreground))]">
                Affiliated with <strong className="text-[hsl(var(--primary))]">Visvesvaraya Technological University (VTU)</strong>, Belagavi, Karnataka, since 2008. This ensures our curriculum meets modern industry standards.
              </p>
            </motion.div>
