      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-gat-steel font-body leading-relaxed pr-4">
              Join Vijaya Vittala Institute of Technology for INNOVATE IGNITE '26 – a celebration of innovation, creativity, and technology. Where Code Meets Culture.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm">
              ...
              <li>
                <Link href="/about" className="text-gat-steel hover:text-gat-gold transition-colors">About VVIT</Link>
              </li>
              <li>
        ...
        <div className="mt-16 pt-8 border-t border-gat-cobalt/30 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gat-steel font-body">
            Copyright © 2026 Vijaya Vittala Institute of Technology · All Rights Reserved.
          </p>
          <p className="text-xs text-gat-steel font-body">
            Developed with ♥ by the Innovate Ignite '26 Website Team
          </p>
        </div>
      </div>
    </footer>
